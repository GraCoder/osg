    ...
    _extensionData(s_extensionData)
{
    ...
    setGLExtensionFuncPtr(glClearBufferiv, "glClearBufferiv", "glClearBufferiv", validContext);
    setGLExtensionFuncPtr(glClearBufferuiv, "glClearBufferuiv", "glClearBufferuiv", validContext);
    setGLExtensionFuncPtr(glClearBufferfv, "glClearBufferfv", "glClearBufferfv", validContext);
    setGLExtensionFuncPtr(glClearBufferfi, "glClearBufferfi", "glClearBufferfi", validContext);
  ...
  setGLExtensionFuncPtr(debugMessageCallback, "glDebugMessageCallback", "glDebugMessageCallbackEXT", validContext);
  setGLExtensionFuncPtr(debugMessageControl, "glDebugMessageControl", "glDebugMessageControlEXT", validContext);
  if (osg::isGLExtensionSupported(contextID, "GL_ARB_debug_output")) {
    glEnable(GL_DEBUG_OUTPUT);
    glEnable(GL_DEBUG_OUTPUT_SYNCHRONOUS);
    debugMessageCallback(DebugOutput, nullptr);
